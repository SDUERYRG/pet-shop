        ...
        <ElTable :data="orders" stripe="true" style="width: 100%;">
            ...
            <ElTableColumn label="操作" width="180">
                <template #default="scope">
                    <ElButton type="primary" @click="fetchOrderItems(scope.row.orderId,scope.row.orderNum);dialogVisible=true;">查看</ElButton>
    ...
    setup() {
        ...
        const fetchOrders = async () => {
            try {
                ...
                const response = await axios.get(`http://localhost:4001/diary-server/order/0/10`, {
                    headers: {
                        'token': token,
                    }
                });
